...
{
    class PanelEx : System.Windows.Forms.Panel
    {

        public Color _borderColor = Color.FromArgb(23, 169, 254);
        public int _radius = 10;
        public RoundStyle _roundeStyle;
        private Read.plugin.ButtonEx buttonEx1;
        ...
        public void DrawBorder(Graphics g, Rectangle rect, RoundStyle roundStyle, int radius)
        {
            rect.Width -= 1;
            rect.Height -= 1;
